...
export default function Comments() {
    ...
    function createComment(text, setText) {
        ...
        .then(newComment => {
            ...
            // or setComments([newComment, ...comments]);
            // comment form을 비운다: 초기화
            setText("")
        })
        .catch(error => {
    ...
    function deleteComment(commentId) {
        ...
        .then(res => {
            ...
            const updatedCommentList = comments.filter(comment => commentId !== comment._id);
        ...
        <li className="mb-4 border-b">
            ...
            <div className="flex">
                <button onClick={toggleFavorite}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className={"w-3 " + (comment.isFavorite ? "fill-red-500" : "fill-gray-200")}>
